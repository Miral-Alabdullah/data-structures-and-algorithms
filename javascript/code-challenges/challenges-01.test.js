...
const addExclamation = (arr) => {
  const arrayOfString = [];
  arr.forEach(element => arrayOfString.push(element + '!'));
...
const allUpperCase = (arr) => {
  const arrayOfString = [];
  arr.forEach(element => arrayOfString.push( element.toUpperCase()));
  return arrayOfString;
};
...
const speaker = (words, callback) => {
  const arrayOfString = [];
  words.forEach(element => arrayOfString.push(callback(element)));
  return arrayOfString;
};
