...
const raisedToTheThird = (arr) => {
  ...
  arr.forEach(element => arrayOfNumbers.push(Math.pow(element, 3)));
...
const addOne = (arr) => {
  const map1 = arr.map(element => element+1);
  return map1;
};
...
const addQuestion = (arr) => {
  const map1 = arr.map(element => element + '?');
  return map1;
};
...
const forLoopTwoToThe = (arr) => {
  const arrayOfTwoToThe = [];
  for (let index = 0; index < arr.length; index++) {
    arrayOfTwoToThe.push(Math.pow(2, arr[index]));
  }
  return arrayOfTwoToThe;
};
...
const forEachTwoToThe = (arr) => {
  const arrayOfTwoToThe = [];
  arr.forEach(element => {
    arrayOfTwoToThe.push(Math.pow(2, element));
  });
  return arrayOfTwoToThe;
};
...
const mapTwoToThe = (arr) => {
  const TwoToThe = arr.map(element => {
